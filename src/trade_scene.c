...
static const u32 sWirelessCloseup_Map[]             = INCBIN_U32("graphics/trade/wireless_signal_closeup.bin.smol");
...
static const u32 sWirelessSignalTilemap[]           = INCBIN_U32("graphics/trade/wireless_signal.bin.smol");
