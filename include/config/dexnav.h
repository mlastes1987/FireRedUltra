...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_0x30C // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_0x30D // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_0x30E // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_0x4092 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_0x4093 // Steps for finding hidden pokemon
