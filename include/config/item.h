...
#define I_EXP_SHARE_FLAG        FLAG_0x30F           // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define I_ORAS_DOWSING_FLAG         FLAG_0x310           // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.
